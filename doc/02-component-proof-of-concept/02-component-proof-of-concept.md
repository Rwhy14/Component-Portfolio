...
In the beginning I was more toward choosing Virus Inflection Tracker as my design since I would want to do a project related to bio. However, I figured that I didn't have a general idea of how to collect the data from worldwide which means that I didn't target a certain population and region for my project. One of the considerations will be time usage. Thus, I chose player stats tracker as my choice since I already focused on certain players and it will be more limited (if that makes sense). For nutrition tracker, I just don't find that interesting at all.
...
- Designed a proof of concept for player stats tracker component

### Updated

- Changed design to include basic concepts and an example of main method.
- Created a java file
